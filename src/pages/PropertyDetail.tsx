...
const PropertyDetail = () => {
      ...
      <>
        ...
        <main className="pt-24 min-h-screen bg-background flex items-center justify-center">
          <div className="text-center">
            ...
            <Link to="/propiedades" className="text-sm underline hover:text-burgundy transition-colors">
  ...
  const mainImage = images[0]?.image_url ?? 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?q=80&w=1200&auto=format&fit=crop';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
                {property.habitaciones != null && (
                  <div className="bg-muted rounded-2xl p-4 text-center">
                    <Bed className="w-5 h-5 mx-auto mb-1 text-burgundy" />
                ...
                {property.banios != null && (
                  <div className="bg-muted rounded-2xl p-4 text-center">
                    <Bath className="w-5 h-5 mx-auto mb-1 text-burgundy" />
                ...
                {property.area != null && (
                  <div className="bg-muted rounded-2xl p-4 text-center">
                    <Square className="w-5 h-5 mx-auto mb-1 text-burgundy" />
                ...
                {property.estacionamientos != null && (
                  <div className="bg-muted rounded-2xl p-4 text-center">
                    <Car className="w-5 h-5 mx-auto mb-1 text-burgundy" />
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-card border border-border rounded-2xl p-6 shadow-card">
                <p className="font-serif text-3xl mb-1 text-burgundy">{formatPrice(property.precio)}</p>
                ...
                {user && (
                  <div className="flex items-center gap-3 mb-6 pb-6 border-b border-border">
                    {user.imagen_perfil_usuario ? (
                      ...
                      <div className="w-12 h-12 rounded-full bg-burgundy/10 flex items-center justify-center font-serif text-xl text-burgundy">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3 bg-[#25D366] hover:bg-[#1ebe5d] text-white rounded-full font-sans font-medium text-sm transition-colors"
                >
                ...
                <div className="space-y-3">
                  <h4 className="font-serif text-lg text-foreground font-medium">¿No es lo que buscas?</h4>
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 w-full py-3 border border-burgundy text-burgundy hover:bg-burgundy hover:text-white rounded-full font-sans font-medium text-xs transition-all duration-300"
                  >
